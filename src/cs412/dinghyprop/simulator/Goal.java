...
/**
*  This class is a sublcass of Point and
*  allows for Goal objects to be created.
*/
public class Goal extends Point{
	
	/**
	*  The constructor that sets up the 
	...
	*/
	...
	/**
	*  This method determines if the Dinghy
	*  has reached the goal.
	*  @param dinghy Reference to the dinghy to determine if it has reached the goal.
